...
Object.assign(LABELS, { historical_hot: '历史热门解读', find: 'Find 按需查找', reason: '原因', product_scope_paused: '当前产品范围已暂停' });
...
export default function RardarDailyOperations() {
  ...
  return <Panel role="region" aria-label="Rardar 每日自动更新" className="mb-6 space-y-3 p-6">
    ...
    <p className="text-sm">当前范围：双榜 Today 零模型采集、历史热门少量资料解读；Find 保留交互优先。News、Discover 及其专属积压已暂停。</p>
