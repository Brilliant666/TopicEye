    ...
    *,
    ...
    return (
        SelectionApiResponse(
            ...
            sourceObservation=visible.sourceObservationSetId,
            sourceTodayGeneration=visible.sourceTodayGeneration,
            generatedAt=visible.generatedAt,
            latestCaptureAt=visible.latestCaptureAt,
            latestAttemptCaptureAt=latest.latestCaptureAt,
            items=items,
            ...
            provenance={
                ...
                "sourceObservation": visible.latestCaptureId,
                "sourceObservationAt": visible.latestCaptureAt.isoformat(),
                "sourceTodayGeneration": visible.sourceTodayGeneration,
                "sourceCoverageState": visible.sourceCoverageState,
            ...
            unprocessedCount=latest.unprocessedCount,
