...
export default defineConfig({
  testDir: './e2e',
  testMatch: ['find-production.spec.ts', 'today-operations-production.spec.ts', 'discover-operations-production.spec.ts', 'daily-operations-production.spec.ts', 'refocus-production.spec.ts'],
  workers: 1,
  retries: 0,
  timeout: 30_000,
