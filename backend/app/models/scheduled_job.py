...
class ScheduledJob(Base):
    ...
    job_type: Mapped[str] = mapped_column(String(50), nullable=False, default="cron",
                                          comment="cron / interval")
    cron_expr: Mapped[Optional[str]] = mapped_column(String(100), nullable=True, comment="cron 表达式")
    interval_seconds: Mapped[Optional[int]] = mapped_column(Integer, nullable=True, comment="interval 间隔秒数")
