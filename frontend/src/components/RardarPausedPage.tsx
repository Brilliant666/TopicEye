...
export default function RardarPausedPage({ title }: { title: string }) {
  ...
  return <section className="mx-auto max-w-3xl px-5 py-12">
    ...
    <p className="mt-6"><Link href="/" className="text-blue-700">浏览今日热榜</Link> · <Link href="/historical-hot" className="text-blue-700">认识历史热门项目</Link> · <Link href="/find" className="text-blue-700">按需求找项目</Link></p>
  </section>;
}
