...
def add_indexes(conn: sqlite3.Connection) -> None:
    ...
    indexes = [
        ...
        ("trending_snapshots", "ix_trending_snapshots_date",
...
def get_current_indexes(conn: sqlite3.Connection) -> dict:
    ...
    tables = ['content_items', 'ai_analyses', 'sources', 
              'trending_items', 'trending_snapshots']
    result = {}
    for t in tables:
